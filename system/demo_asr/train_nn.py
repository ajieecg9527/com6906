...
def evaluate(cfg: DictConfig) -> None:
    ...
    for signal in train_signal_list:
        train_df.loc[train_df["signal"] == signal, "encoder_similarity"] = dev_encoder_similarity[signal]
        train_df.loc[train_df["signal"] == signal, "decoder_similarity"] = dev_decoder_similarity[signal]
